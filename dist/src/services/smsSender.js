...
exports.sendSmsToNumber = sendSmsToNumber;
 ...
 */
async function sendSmsToNumber(rawPhone, message) {
    const normalized = (0, normalizePhone_1.normalizeUSPhone)(rawPhone);
...
exports.sendSms = sendSmsToNumber;
